...
private slots:
    ...
    QString BuyBOXY(QString OrderType, double Quantity, double Rate);
    QString SellBOXY(QString OrderType, double Quantity, double Rate);
